<%@ Page Title="" Language="C#" MasterPageFile="~/ShrutikaScans.master" AutoEventWireup="true" CodeFile="Login1.aspx.cs" Inherits="Login1" %>
...
&nbsp;&nbsp;&nbsp;
            ...
            <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="30pt" ForeColor="#666666" style="top: 265px; left: 622px; position: absolute; height: 54px; width: 166px" Text="LOGIN"></asp:Label>
            <p>
            </p>
            <p>
                &nbsp;</p>
            ...
            <div class="div" style="top: 362px; left: 811px; position: absolute; height: 433px; width: 491px; background-color: #008080;">
                <asp:TextBox ID="TextBox2" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" style="top: 160px; left: 214px; position: absolute; height: 32px; width: 220px; background-color: #FFFFFF" TextMode="Password"></asp:TextBox>
                <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Names="Cambria" Font-Size="Large" ForeColor="White" style="top: 100px; left: 64px; position: absolute; height: 39px; width: 137px; background-color: #008080" Text="USERNAME"></asp:Label>
                <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Names="Cambria" Font-Size="Large" ForeColor="White" style="top: 167px; left: 63px; position: absolute; height: 34px; width: 129px; background-color: #008080" Text="PASSWORD"></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" style="top: 95px; left: 213px; position: absolute; height: 32px; width: 220px; background-color: #FFFFFF"></asp:TextBox>
                <asp:Button ID="Button2" runat="server" CssClass="btn" BackColor="White" BorderColor="White" BorderStyle="None" Font-Bold="True" Font-Names="Cambria" Font-Size="Large" ForeColor="Teal" style="top: 267px; left: 190px; position: absolute; height: 36px; width: 119px; background-color: #FFFFFF" Text="LOGIN " OnClick="Button2_Click" />
    </div>
            <p>
            </p>
            <p>
